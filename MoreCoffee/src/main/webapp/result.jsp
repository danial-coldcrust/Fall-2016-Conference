...
<%@ page import= "com.ppp.grade.minortable.persistence.MinortableDAO,
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse drop_menu" id="navbar">
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-pencil"></span>&nbsp;과목<span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="anch2">학과기초</a></li>
                                <li><a href="anch3">전공</a></li>
                                <li><a href="anch4">필수교양</a></li>
                                <li><a href="anch5">교양</a></li>
                        ...
                        <li><a href="https://portal.sch.ac.kr/" target="_blank"><span class="glyphicon glyphicon-home"></span>&nbsp;포탈</a></li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="RsltToSltController.do"><span class="glyphicon glyphicon-hourglass"></span>&nbsp;Modified</a></li>
        ...
        <div class="container">
            <div class="page-header">
                ...
                <div class="col-md-12 well">
                    ...
                    <p>과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야과목명을 뿌려줄거야</p>
                </div>
            </div>
        </div>
    </div>
